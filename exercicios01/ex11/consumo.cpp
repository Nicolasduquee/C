...
main(){
	...
	printf("Digite o tempo em horas e a velocidade média em km/h:\n");
	scanf("%f%f", &t, &velMed);
	...
	printf("\n");
	printf("A %.2f km/h, por %.2f horas, a distância percorrida será:\n\n", velMed, t);
	printf("%.2f km\n\n", d);
	printf("Considerando que o carro consome 15L/km, o consumo total será:\n");
	printf("%.2f L\n\n", c);
